...
def test_verify_csv_vs_svr():
    ...
    x = test.verify_csv_vs_svr(dhcp_dm)
    ...
    assert x['missing_entries'] == ['10.10.10.10'], 'Error with detecting missing reservations'
    assert sorted(x['used_entries']) == [('10.10.10.5', 'computer6.steswor', '6a-6b-6c-6d-6e-6f'), ('10.10.20.6', 'computer5.steswor', '5a-5b-5c-5d-5e-5f')
